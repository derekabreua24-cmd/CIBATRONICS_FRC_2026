...
public final class Constants {
  ...
  // Physical constants (assumptions - tune to your robot)
  // Wheel diameter: 6 inches -> meters
  ...
  public static final double kDriveKS = 0.2; // volts (static)
  public static final double kDriveKV = 1.2; // volts per (m/s)
  public static final double kDriveKA = 0.05; // volts per (m/s^2)

  // Estimated maximum linear speed (m/s) used for safe voltage clamping fallback
